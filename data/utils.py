...
def eval_dict(y_pred, y, y_prob=None, file_names=None, sample_weights=None, average='macro'):
    """
    Args:
        sample_weights: Optional, sample weights for F1 calculation
    ...
    if y is not None:
        if sample_weights is not None:
            weighted_f1 = f1_score(y_true=y, y_pred=y_pred, average=average, sample_weight=sample_weights)
            scores_dict['weighted_F1'] = weighted_f1
        else:
