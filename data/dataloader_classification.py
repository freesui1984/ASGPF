...
class SeizureDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.standardize:
            ...
            # # 对log_amplitude_feature_matrix进行最大最小标准化
            # min_max_scaler = MinMaxScaler()
            # curr_feature = min_max_scaler.fit_transform(curr_feature.reshape(-1, curr_feature.shape[-1])).reshape(curr_feature.shape)
