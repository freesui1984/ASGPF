...
from data.dataloader_ssl_bids import load_bids_dataset_ssl
from constants import *
from args import get_args
from collections import OrderedDict
from json import dumps
from model.model import DCRNNModel_nextTimePred
from model.ASGPFmodel import SGLCModel_nextTimePred
...
def main(args):
    ...
    if args.ssl_model == 'dcrnn':
        model = DCRNNModel_nextTimePred(device=device, args=args)
    else:
        model = SGLCModel_nextTimePred(device=device, args=args)
        ...
        with torch.enable_grad(), \
            ...
            for x, y, _, supports, _, _ in train_loader:
                ...
                if args.ssl_model == "asgpf":
                    ...
                    supports = torch.squeeze(adjacency_matrix, dim=0)
