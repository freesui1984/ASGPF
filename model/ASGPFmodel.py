...
from model.cell import SGLCell
...
class SGLCDecoder(nn.Module):
    def __init__(self, args, input_dim, num_nodes,
                 hid_dim, num_steps, output_dim, num_rnn_layers, gcgru_activation=None,
...
class SGLCModel_classification(nn.Module):
    def __init__(self, args, num_classes, device=None):
        ...
        self.encoder = SGLCEncoder(args=args,
                                    input_dim=enc_input_dim,
                                    hid_dim=rnn_units, num_nodes=num_nodes,
                                    num_steps=num_steps,
                                    num_rnn_layers=num_rnn_layers,
                                    gcgru_activation=args.gcgru_activation)
...
class SGLCModel_nextTimePred(nn.Module):
    def __init__(self, args, device=None):
        ...
        self.encoder = SGLCEncoder(args=args,
                                    ...
                                    num_rnn_layers=num_rnn_layers,
                                    gcgru_activation=args.gcgru_activation)
        self.decoder = SGLCDecoder(args=args,
